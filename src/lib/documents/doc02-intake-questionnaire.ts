...
import { h1, h2, p, kv, buildSection, officialStamp, callout } from "./helpers";
  ...
  return new Document({
    sections: [
      buildSection([
        ...
        h2("2. Impact & History"),
        p("Consequence of Failure:", true),
        callout(data.consequence_of_failure || "N/A"),
        p("Previous Attempts to Automate:", true),
        ...
        p("Success Definition:", true),
        callout(data.success_definition || "N/A"),
