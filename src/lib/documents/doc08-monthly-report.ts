  ...
  return new Document({
    sections: [
      buildSection([
        ...
        kv("Reporting Period", `${data.report_month} ${data.report_year}`),
        
        h2("1. Executive Summary"),
        callout(data.executive_summary || "Operations ran smoothly over the reporting period. All key metrics remained within target thresholds."),
        ...
        p(""),
        p(`Next scheduled review: ${data.next_report_date || "To be confirmed"}`, true),
