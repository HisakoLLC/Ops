    ...
    sections: [
      {
        children: [
          ...
          rule(),
          p(`This Non-Disclosure Agreement (the "Agreement") is entered into on ${data.nda_date ?? '[NOT PROVIDED]'} (the "Effective Date"), by and between:`),
          
          h2("Parties"),
          p("1. HISAKO TECHNOLOGIES, a company registered in the United Kingdom (the \"Disclosing Party\")."),
          p(`2. ${data.recipient_company ?? '[NOT PROVIDED]'}, represented by ${data.recipient_name ?? '[NOT PROVIDED]'} (the "Receiving Party").`),
          ...
          kv(data.recipient_company ?? "[COMPANY]", "___________________________"),
        ],
      },
    ],
  });
