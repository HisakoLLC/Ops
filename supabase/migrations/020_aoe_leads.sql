...
create unique index aoe_leads_lead_id_idx on public.aoe_leads(aoe_lead_id);

-- Index for common queries
create index aoe_leads_status_idx on public.aoe_leads(status);
create index aoe_leads_email_idx on public.aoe_leads(contact_email);
create index aoe_leads_created_idx on public.aoe_leads(created_at desc);
